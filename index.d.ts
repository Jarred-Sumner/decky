...
declare type DesignTimePropertyDecoratorFunction<T> = (
  property: DesignTimeProperty<T>
) => void | any;
export declare type DesignTimePropertyDecorator<T> = (
  ...args: string[]
...
declare type DesignTimeClassFunction<T> = (
  klass: DesignTimeClass<T>
) => void | any;
export declare type DesignTimeClassDecorator<
  T
> = () => DesignTimeClassFunction<T>;
...
declare type OptionalPropertyDescriptor<T> = T extends Exclude<
  (number | string)[],
  undefined
>
